...
public class pracProg {
    ...
    public static void main(String[] args)
    {
     ...
     if(llamas > whales)
            System.out.println("Whales may be bigger, but llams are better, ha!");
     if(llamas <= whales)
     {
        ...
        if(llamas > whales && whales > dodos)
            System.out.println("I don't know how, but the llamas have com out ahead! Sneaky!");
    }
}
